...
export function ProductCategoriesGrid({ locale, categories }: { locale: string, categories?: SanityCategory[] }) {
  ...
  const getLayoutClass = (slug: string, index: number) => {
    ...
    if (slug === "machines") return "col-span-1 md:col-span-1 lg:col-span-2 lg:row-span-1"; // Horizontal Feature (2 slots)
  ...
  return (
    <section className="relative w-full overflow-hidden py-24 bg-black" id="products">
      <div className="w-full">
        ...
        <BentoGrid>
          {displayCategories.map((cat, index) => {
            ...
            const image = cat.image || fallbacks[cat.slug.current] || "/images/categories/machines.png";
