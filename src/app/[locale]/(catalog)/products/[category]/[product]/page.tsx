...
export default async function ProductPage(props: {
  ...
  const jsonLd = {
    ...
    brand: {
      '@type': 'Brand',
      name: productData.brand?.title || "Middle Ocean Printing",
    },
    offers: {
      '@type': 'Offer',
  ...
  return (
    <>
      ...
      <div className="relative z-10 bg-background text-foreground min-h-screen pt-12 lg:pt-20 print:pt-0 print:bg-white print:text-black">
        <article className="container mx-auto px-6 py-6 lg:py-10 print:py-0 print:px-0">

          {/* Print header */}
          <div className="hidden print:flex items-center justify-between pb-8 mb-8 border-b-2 border-zinc-200">
            <Image src="/brand/logo.svg" alt="Logo" width={160} height={40} className="h-10 w-auto invert" />
            <div className="text-right">
              <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest leading-none">Product Specification Sheet</h2>
              <p className="text-xs text-zinc-400 mt-1">{new Date().toLocaleDateString(locale)}</p>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-7">
              <div className="space-y-2">
                <div className="inline-flex items-center gap-2 font-mono text-xs font-bold tracking-[0.2em] text-white/50 print:text-zinc-500">
                  {productData.brand?.title && <span className="uppercase">{productData.brand.title} •&nbsp;</span>}
                  {partNumber}
                </div>
                <h1 className={cn(
              ...
              <div className="space-y-3">
                <h2 className="text-base font-bold uppercase tracking-widest text-muted-foreground print:text-black">
          ...
          <div className="pt-12 print:pt-10 space-y-12">
            <div className="space-y-3">
              <h2 className={cn(
