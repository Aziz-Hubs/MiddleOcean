...
export default function ContactPageClient({ settings, locale }: { settings: any, locale: string }) {
  ...
  useEffect(() => {
    ...
    // Defer map showing to ensure hydration is complete and UI is responsive
...
function ContactCard({ icon, title, content, actionLabel, onAction, copyAction, copied, t }: any) {
  return (
    <motion.div
      whileHover={{ y: -5 }}
